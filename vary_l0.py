...
#parameters
E = 15
l0s = np.linspace(np.sqrt(10),np.sqrt(15),5)
Ds_i = 0
Ds_f = 0.5
l1,l2 = 0.995,1.015
...
for l0 in l0s:
    ...
    plt.plot(Ds2,lms_opt2,'.-',label=r'$l_0=$'+str(int(l0*1000)/1000))
    ...
    if i_ints:
        plt.axvline(x=Ds2[min(i_ints)],linestyle='--',linewidth=2,
                label='int:$l_0=$'+str(int(l0*1000)/1000))
